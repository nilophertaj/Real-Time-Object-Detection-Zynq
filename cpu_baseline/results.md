...
The CPU-only implementation achieves near real-time performance but utilizes high CPU resources and exhibits higher latency compared to hardware acceleration.
